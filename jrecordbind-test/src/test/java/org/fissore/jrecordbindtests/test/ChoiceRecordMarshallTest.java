...
public class ChoiceRecordMarshallTest {
  ...
  public void setUp() {
    ...
    One one = new One();
    one.setType("record id will be ignored because there's a 'fixed' value");
    one.setSomething("2");
    ...
    Two two = new Two();
    two.setType("record id will be ignored because there's a 'fixed' value");
    two.setSomething("3");
    ...
    three.setType("record id will be ignored because there's a 'fixed' value");
    ...
    Four four = new Four();
    four.setType("record id will be ignored because there's a 'fixed' value");
    four.setSomething("1");
