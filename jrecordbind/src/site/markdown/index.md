...
Take a look at the [example project](https://github.com/ffissore/jrecordbind/tree/3.1.0/jrecordbind-example), read the how-tos below, and play with the [tests](https://github.com/ffissore/jrecordbind/tree/3.1.0/jrecordbind-test/src/test/resources/record_definitions).
...
When the definition is ready, generate the beans: use [JAXB2 Maven plugin](https://github.com/highsource/maven-jaxb2-plugin) (for an example configuration, give a look at the [test pom.xml](https://github.com/ffissore/jrecordbind/blob/3.1.0/jrecordbind-test/pom.xml)).
...
Take a look at the [example project](https://github.com/ffissore/jrecordbind/tree/3.1.0/jrecordbind-example).
...
JRecordBind can easily recognize each record type using the XML Schema standard attribute `fixed`: [see this example](https://github.com/ffissore/jrecordbind/blob/3.1.0/jrecordbind-test/src/test/resources/record_definitions/hierarchical.def.xsd).

### Dynamic length files

You can omit the `jrb:length` attribute and instead specify the `jrb:delimiter` attribute: this way you get a **dynamic-length** file: [see this example](https://github.com/ffissore/jrecordbind/blob/3.1.0/jrecordbind-test/src/test/resources/record_definitions/dynamic_length.def.xsd).

### Extend the generated bean

Add the `jrb:subclass` attribute to the `xs:complexType` tag. By specifying the fully qualified name of a class extending the generated class, JRecordBind will instantiate that class instead of the generated one, allowing you to extend/override the generated class: [see this example](https://github.com/ffissore/jrecordbind/blob/3.1.0/jrecordbind-test/src/test/resources/record_definitions/enum.def.xsd).
...
[See this example](https://github.com/ffissore/jrecordbind/blob/3.1.0/jrecordbind-test/src/test/resources/record_definitions/choice.def.xsd#L24).
...
In order to customize such behaviour, create an `Unmarshaller` passing an implementation of the `LineReader` interface: [see this example](https://github.com/ffissore/jrecordbind/blob/3.1.0/jrecordbind-test/src/test/java/org/fissore/jrecordbindtests/test/SimpleNotPaddedLineReaderUnmarshallTest.java).
...
Take a look at the [repository](https://github.com/ffissore/jrecordbind/tree/3.1.0/jrecordbind-test/src/test/resources/record_definitions).
